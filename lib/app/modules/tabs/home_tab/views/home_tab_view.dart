...
class HomeTabView extends GetWidget<HomeTabController> {
  @override
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  children: [
                                    (!isNullEmptyOrFalse(
                                            controller.imageFromFirebase.value))
                                        ? ClipRRect(
                                            ...
                                            child: Container(
                                              ...
                                              child: Image.memory(
                                                  base64Decode(controller
                                                      .imageFromFirebase.value),
                                                  fit: BoxFit.cover),
                                            ),
                                          )
                                        : CircleAvatar(
                                            backgroundImage:
                                                AssetImage("assets/user01.jpg"),
                                          ),
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          "Hey, ${(isNullEmptyOrFalse(box.read(ArgumentConstant.userName))) ? "John Doe." : box.read(ArgumentConstant.userName)}",
                                          style: TextStyle(
                                              fontSize:
                                                  getFontSize(17, context)),
                                        ),
                                        Text(
                                          "52 Games, 230 Points",
                                          style: TextStyle(
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Container(
                                        padding:
                                            EdgeInsets.all(getSize(5, context)),
